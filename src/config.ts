...
export function loadConfig(): Config {
  ...
  const configFile = process.env.FILENAME_CHECK_CONFIG_PATH;
  if (!configFile) {
    gutil.log(ModuleName, gutil.colors.yellow('Not set env FILENAME_CHECK_CONFIG_PATH, use default config'));
